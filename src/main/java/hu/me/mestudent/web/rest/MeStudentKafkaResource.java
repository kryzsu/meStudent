...
@RestController
@RequestMapping("/api/me-student-kafka")
public class MeStudentKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MeStudentKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MeStudentKafkaResource(KafkaProperties kafkaProperties) {
