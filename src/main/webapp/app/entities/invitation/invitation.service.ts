...
export class InvitationService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/invitations';
  ...
  search(req: Search): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IInvitation[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
